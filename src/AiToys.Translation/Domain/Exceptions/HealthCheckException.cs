...
/// <summary>
/// Exception thrown when an error occurs during the health check process.
/// </summary>
[Serializable]
public class HealthCheckException : Exception
{
    ...
    public HealthCheckException()
        : base("An error occurred during the health check process.") { }
    ...
    public HealthCheckException(Exception innerException)
        : base("An error occurred during the health check process.", innerException) { }
